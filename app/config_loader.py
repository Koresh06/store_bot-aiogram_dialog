...
def load_config() -> Config:
    ...
    bot_config = BotConfig(token=bot_config_data.get('token', ''), admin_id=bot_config_data.get('admin_id', ''), token_yookassa=bot_config_data.get('token_yookassa', ''), channel_id=bot_config_data.get('channel_id', ''), channel_url=bot_config_data.get('channel_url', ''), WEBHOOK_URL=bot_config_data.get('WEBHOOK_URL', ''))
